...
USE agtestdb;
GO
INSERT INTO Inventory VALUES (600, 'after force fo node_a', 154);
GO
...
USE agtestdb;
GO
INSERT INTO Inventory VALUES (700, 'after removing node_c', 154);
GO
...
TO DISK = '/var/opt/mssql/data/backups/agtestdb.bak'
   WITH FORMAT,
      MEDIANAME = 'SQLServerBackups',
      NAME = 'Full Backup of agtestdb';
GO
...
USE agtestdb;
GO
INSERT INTO Inventory VALUES (800, 'Dif backup', 154);
GO
INSERT INTO Inventory VALUES (801, 'Dif backup', 154);
GO
INSERT INTO Inventory VALUES (802, 'Dif backup', 154);
GO
...
BACKUP DATABASE agtestdb
   TO DISK = '/var/opt/mssql/data/backups/agtestdb.DIF'
   WITH DIFFERENTIAL;  
GO  
...
USE agtestdb;
GO
INSERT INTO Inventory VALUES (900, 'Log backup', 154);
GO
INSERT INTO Inventory VALUES (901, 'Log backup', 154);
GO
INSERT INTO Inventory VALUES (902, 'Log backup', 154);
GO
...
use [master]
BACKUP LOG agtestdb
   TO DISK = '/var/opt/mssql/data/backups/agtestdb.trn';  
...
USE agtestdb;
GO
INSERT INTO Inventory VALUES (1000, 'New data', 154);
GO
