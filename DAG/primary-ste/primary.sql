...
CREATE AVAILABILITY GROUP [AG1]
      ...
      N'mssql-primary-0'
            WITH (
            ENDPOINT_URL = N'tcp://mssql-primary-0.mssql-primary-hl:5022',
       ...
       N'mssql-primary-1'
            WITH (
            ENDPOINT_URL = N'tcp://mssql-primary-1.mssql-primary-hl:5022',
            AVAILABILITY_MODE = SYNCHRONOUS_COMMIT,
               SEEDING_MODE = AUTOMATIC,
               FAILOVER_MODE = MANUAL,
            SECONDARY_ROLE (ALLOW_CONNECTIONS = ALL)
...
USE agtestdb;
GO
INSERT INTO inventory VALUES (200, 'global again', 150);
GO
...
ALTER AVAILABILITY GROUP [ag1] REMOVE LISTENER 'ag1-listener';

-- Then, add the listener with the correct syntax
ALTER AVAILABILITY GROUP [ag1]
    ADD LISTENER 'ag1-listener'
    (
        WITH IP (('139.162.26.126', '255.255.0.0')),
        PORT = 1433
    );
